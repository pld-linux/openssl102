...
Entschl¸sselungsalgorithmen und
- -protokolle, wie DES, RC4, RSA und SSL zur Verf¸gung stellen.
...
%description -l pl
Implementacja protoko≥Ûw kryptograficznych Secure Socket Layer (SSL)
